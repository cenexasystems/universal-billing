...
-- ============================================================
-- Migration: 20260716_0001_purple_boutique_schema.sql
-- ============================================================
...
AS $$
BEGIN
  -- Neon stub: Supabase auth trigger removed
  RETURN NEW;
END;
$$;

-- [NEON] handle_new_user stub ends here (orphan body removed)
-- [NEON] on_auth_user_created trigger on auth.users skipped
  ...
  FOR v_attempt IN 1..5 LOOP
    ...
    BEGIN
      INSERT INTO public.orders (
        ...
        v_invoice_no, NULL::UUID, COALESCE(NULLIF(BTRIM(p_customer_name), ''), 'Customer'),
...
-- [NEON] Skipped: REVOKE ALL ON FUNCTION public.get_public_invoice_by_number(TEXT) FROM PUBLIC;
-- [NEON] Skipped: -- [NEON] Removed GRANT
...
-- [NEON] Skipped: ALTER TABLE public.profiles ENABLE ROW LEVEL SECURITY;
-- [NEON] Skipped: ALTER TABLE public.categories ENABLE ROW LEVEL SECURITY;
-- [NEON] Skipped: ALTER TABLE public.products ENABLE ROW LEVEL SECURITY;
-- [NEON] Skipped: ALTER TABLE public.product_variants ENABLE ROW LEVEL SECURITY;
-- [NEON] Skipped: ALTER TABLE public.coupons ENABLE ROW LEVEL SECURITY;
-- [NEON] Skipped: ALTER TABLE public.orders ENABLE ROW LEVEL SECURITY;
-- [NEON] Skipped: ALTER TABLE public.order_items ENABLE ROW LEVEL SECURITY;
-- [NEON] Skipped: ALTER TABLE public.store_settings ENABLE ROW LEVEL SECURITY;
...
-- [NEON] Skipped: storage.buckets insert
-- [NEON-SKIP] VALUES ('invoices', 'invoices', TRUE, 10485760, ARRAY['application/pdf'])
-- [NEON-SKIP] ON CONFLICT (id) DO UPDATE SET public = TRUE, file_size_limit = 10485760, allowed_mime_types = ARRAY['application/pdf'];

-- [NEON] Skipped: storage policy
-- [NEON] Skipped: storage policy
-- [NEON] Skipped: storage policy
-- [NEON] Skipped: storage policy
-- [NEON] Skipped: storage policy
...
-- ============================================================
-- Migration: 20260716_0002_purple_boutique_catalog.sql
-- ============================================================
...
-- ============================================================
-- Migration: 20260716_0003_order_rpc_compatibility.sql
-- ============================================================
  ...
  FOR v_attempt IN 1..5 LOOP
    ...
    BEGIN
      INSERT INTO public.orders (
        ...
        v_order_id, v_invoice_no, NULL::UUID,
...
-- ============================================================
-- Migration: 20260719_0004_advance_orders.sql
-- ============================================================
begin;
...
begin
  ...
  values(v_deposit_id,trim(p_customer_name),trim(p_phone),trim(coalesce(p_address,'')),trim(p_product_name),case when jsonb_typeof(coalesce(p_products,'[]'::jsonb))='array' then coalesce(p_products,'[]'::jsonb) else '[]'::jsonb end,trim(coalesce(p_category,'')),trim(coalesce(p_description,'')),round(p_total_amount,2),round(p_deposit_amount,2),p_expected_delivery_date,trim(coalesce(p_remarks,'')),NULL::UUID,trim(coalesce(p_created_by_name,'')),v_now,v_now)
...
begin
  ...
  insert into public.advance_order_timeline(advance_order_id,event_type,label,remarks,created_by) values(p_order_id,p_status,v_label,coalesce(p_remarks,''),NULL::UUID);
  return v_order;
end;
$$;
...
begin
  ...
  insert into public.advance_order_timeline(advance_order_id,event_type,label,remarks,created_by) values(p_order_id,p_event_type,p_label,coalesce(p_remarks,''),NULL::UUID);
end;
$$;
...
begin
  ...
  values(v_order_id,v_invoice,v_advance.customer_name,v_advance.phone,v_advance.address,NULL::UUID,v_items,v_advance.total_amount,v_advance.total_amount,'completed','offline','advance_order',0,0,0,0,lower(p_payment_method),lower(p_payment_method),v_now,v_now);
  ...
  insert into public.advance_order_payments(advance_order_id,payment_type,amount,payment_method,remarks,received_by,received_at)
  values(p_order_id,'remaining',v_advance.remaining_balance,lower(p_payment_method),coalesce(p_remarks,''),NULL::UUID,v_now);
...
-- [NEON] Skipped: alter table public.advance_orders enable row level security;
-- [NEON] Skipped: alter table public.advance_order_timeline enable row level security;
-- [NEON] Skipped: alter table public.advance_order_payments enable row level security;
...
grant usage, select on sequence public.deposit_number_seq TO PUBLIC;
grant usage, select on sequence public.invoice_number_seq TO PUBLIC;

grant select, insert, update, delete on public.advance_orders TO PUBLIC;
grant select, insert, update, delete on public.advance_order_timeline TO PUBLIC;
grant select, insert, update, delete on public.advance_order_payments TO PUBLIC;

grant execute on function public.create_advance_order(text,text,text,text,text,text,numeric,numeric,date,text,text,text,jsonb) TO PUBLIC;
grant execute on function public.update_advance_order_status(uuid,text,text) TO PUBLIC;
grant execute on function public.add_advance_order_event(uuid,text,text,text) TO PUBLIC;
grant execute on function public.complete_advance_order(uuid,text,text) TO PUBLIC;
...
-- ============================================================
-- Migration: 20260722_0005_eight_digit_invoice_numbers.sql
-- ============================================================
...
-- ============================================================
-- Migration: 20260724_0006_fix_complete_advance_order.sql
-- ============================================================
...
-- ============================================================
-- Migration: 20260724_0008_fix_public_invoice_rpc.sql
-- ============================================================
...
-- ============================================================
-- Migration: 20260724_0009_create_invoices_bucket.sql
-- ============================================================
...
-- ============================================================
-- Migration: 20260726_0007_update_complete_advance_order_discount.sql
-- ============================================================
...
-- ============================================================
-- Migration: 20260728_0010_final_audit_fixes.sql
-- ============================================================
-- ============================================================
...
-- [NEON] Skipped: ALTER TABLE public.store_reviews ENABLE ROW LEVEL SECURITY;
-- [NEON] Skipped: Policy
-- [NEON] Skipped: Policy
...
-- [NEON] Skipped: GRANT EXECUTE ON FUNCTION public.update_advance_order_status(uuid, text, text) TO authenticated, anon, public;
...
-- [NEON] Skipped: GRANT EXECUTE ON FUNCTION public.add_advance_order_event(uuid, text, text, text) TO authenticated, anon, public;

-- 7. Ensure profiles RLS allows staff to update their own profile (avatar etc)
-- [NEON] Skipped: Policy
-- [NEON] Skipped: Policy
-- [NEON-SKIP]   ON public.profiles FOR UPDATE
-- [NEON-SKIP]   USING (auth.uid() = id);
...
-- ============================================================
-- Migration: 20260808_0011_billing_date_and_order_fields.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- Migration: 20260901_0012_inventory_barcode_addon.sql
-- ============================================================
-- ====================================================================
...
-- [NEON] Skipped: ALTER TABLE public.barcode_registry ENABLE ROW LEVEL SECURITY;
-- [NEON] Skipped: ALTER TABLE public.inventory_movements ENABLE ROW LEVEL SECURITY;
...
-- ============================================================
-- Migration: 20260903_0013_expense_tracker_addon.sql
-- ============================================================
-- ====================================================================
...
-- [NEON] Skipped: ALTER TABLE public.expense_categories ENABLE ROW LEVEL SECURITY;
-- [NEON] Skipped: ALTER TABLE public.expenses ENABLE ROW LEVEL SECURITY;
...
-- [NEON-SKIP]   TRUE,
-- [NEON-SKIP]   10485760,
-- [NEON-SKIP]   ARRAY['image/png', 'image/jpeg', 'image/webp', 'image/svg+xml']
-- [NEON-SKIP] )
-- [NEON-SKIP] ON CONFLICT (id) DO UPDATE SET
-- [NEON-SKIP]   public = TRUE,
-- [NEON-SKIP]   file_size_limit = 10485760;

-- 3. Storage Policies for branding bucket
-- [NEON] Skipped: storage policy
-- [NEON] Skipped: storage policy
-- [NEON-SKIP]   FOR SELECT TO public
-- [NEON-SKIP]   USING (bucket_id = 'branding');

-- [NEON] Skipped: storage policy
-- [NEON] Skipped: storage policy
-- [NEON-SKIP]   FOR INSERT TO PUBLIC
-- [NEON-SKIP]   WITH CHECK (bucket_id = 'branding');

-- [NEON] Skipped: storage policy
-- [NEON] Skipped: storage policy
-- [NEON-SKIP]   FOR UPDATE TO PUBLIC
-- [NEON-SKIP]   USING (bucket_id = 'branding')
-- [NEON-SKIP]   WITH CHECK (bucket_id = 'branding');
...
-- ============================================================
-- Migration: 20260917_0001_fix_soft_delete_unique_constraints.sql
-- ============================================================
...
-- ============================================================
-- Migration: 20260918_0018_advance_order_self_heal.sql
-- ============================================================
-- ============================================================
...
GRANT EXECUTE ON FUNCTION public.complete_advance_order_v2(uuid, text, numeric, text, numeric, numeric, text) TO PUBLIC;
-- [NEON] Skipped: GRANT EXECUTE ON FUNCTION public.update_advance_order_status(uuid, text, text) TO authenticated, anon, public;
