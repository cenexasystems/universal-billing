...
const STORAGE_EXPENSES_KEY = 'universal-look_expenses_records_v1'
const LEGACY_STORAGE_EXPENSES_KEY = 'clad_expenses_records_v1'
const STORAGE_CATEGORIES_KEY = 'universal-look_expense_categories_v1'
...
export function exportExpensesToCSV(expenses: ExpenseRecord[]): void {
  ...
  link.href = url
  link.setAttribute('download', `Universal Look-Expenses-${new Date().toISOString().slice(0, 10)}.csv`)
